#pragma checksum "C:\ProjetosManufatura\JobSetup\20201127_ATUAL\BridgestoneLibras\Views\JobSetup\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e2235499110f620bc09bb947a0a25b3b12866710"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e2235499110f620bc09bb947a0a25b3b12866710", @"/Views/JobSetup/Index.cshtml")]
    ...
    public class Views_JobSetup_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "eb0cf240c9034dfdb4faa038f832e029", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "d4c9c51eab424f0c8a1924958a894556", async() => {
...
<div>
    <script>
        ...
        function montaFormulario(dados) {
            ...
            for (var i = 0; i < dados.length; i++) {
                if (contador == 0) {
                    ...
                    html += ""<h4><label id='identificadorLote'> Lote PCS: "" + dados[i].identificadorLote +  ""</label><button type='button' style='color:red' class='btn btn-default' onclick='AtualizarPCS();' >Voltar</button></h4>"";
                  ");
            WriteLiteral(@"  html += ""</div>"";
                ...
                if (dados[i].id_tipoResposta == 2) {
                    Condicao(dados, i, dados[i].id_t");
            WriteLiteral(@"ipoResposta, dados[i].id_obrigatorio, dados[i].id_formulario, dados[i].chave);
                }
            }
            ...
            html += ""</div>"";
            html += ""<div class='col-lg-3'>"";
            html += ""<button type='button' id='btnLider' onclick='FinalizarRespostaPergunta()' class='btn btn-out");
            WriteLiteral(@"line-danger btn-block'>Finalizar</button>"";
            html += ""</div>"";
        ...
        function AtualizarPCS() {

            $.ajax({
                url: 'AtualizarPCS/JobSetup',
                type: 'POST',
                traditional: true,
                data: JSON.stringify(),
                ...
                success: function (response) {
                    ...
                    var resposta = '';
                    $(""#identificadorLote"").empty();
                    resposta = ""Lote PCS: "" + response.vc_identificador_lote1;
                    $(""#identificadorLote"").append(resposta);
        ...
        function Salvar() {
            ...
            if (!VerificaObrigatoriedadeBotaoSalvar()) {
                ...
                ModalAle");
            WriteLiteral(@"rt(""É necessário responder pelo menos uma  pergunta para salvar o formulário."")
        ...
        function FinalizarRespostaPergunta() {
            ...
            if (VerificaObrigatoriedade()) {
                $.ajax({
                    ...
                    traditional: true,
                   ");
            WriteLiteral(@" data: JSON.stringify(listIdsPerguntas),
                    contentType: 'application/json',
                    success: function (response) {
                        $(""#dvtest"").html(response);
                        listIdsPerguntas = [];
        ...
        function VerificaObrigatoriedadeBotaoSalvar() {
            ...
            WriteLiteral(@") {
                        ...
                        if (listIdsPerguntas[i].valor == """" || listIdsPerguntas[i].valor == null) {
                            //return false;
                            cont++;
                        }
                    ...
                    if (listIdsPerguntas[i].id_tipoResposta == 2) {
                        ...
                        ");
            WriteLiteral(@"            if (listIdsPerguntas[i].Filho[r].id_obrigatorio == 1 && listIdsPerguntas[i].Filho[r].valor == ""0"") {
                                        //return false;
                                        cont++;
                                    }
                                }
            ...
            if (listIdsPerguntas.length > 0) {
                ...
                for (var i = 0; i < listIdsPerguntas.length; i++) {
                    ...
                    if (listIdsPerguntas[i].id_obrigatorio == 1 && (listIdsPerguntas[i].valor == """" || listIdsPerguntas[i].valor == null) && listIdsPerguntas[i].Filho.length == 0) {
                        ...
                        ModalAlert(""Por favor, responda a pergunta "" + listIdsPerguntas[i].nome)
                        return false;
                    }
                    if (listIdsPerguntas[i].id_obrigatorio == 1 &&");
            WriteLiteral(@" (listIdsPerguntas[i].valor == """" || listIdsPerguntas[i].valor == null) && listIdsPerguntas[i].Filho.length > 0 && $(""#"" + listIdsPerguntas[i].id).is("":checked"")) {
                        ...
                        for (var r = 0; r < listIdsPerguntas[i].Filho.length; r++) {
                            ...
                            if (listIdsPerguntas[i].Filho[r].id_tipoResposta == 3) {
                                ...
                                if (listIdsPerguntas[i].Filho[r].id_obrigatorio == 1 && (listIdsPerguntas[i].Filho[r].valor == """" || listIdsPerguntas[i].Filho");
            WriteLiteral(@"[r].valor == null)) {
        ...
        function Text(nome, id, id_tipoResposta, valor, id_obrigatorio, id_formulario, chave) {
            listIdsFilhos = [];
     ");
            WriteLiteral(@"       html += ""<div class='row text-left' style='margin-top:10px;'>"";
        ...
        function Numero(nome, id, id_tipoResposta, valor, id_obrigatorio, id_formulario, chave) {
            ...
            html += ""</div>"";
            html += ""<div class='col-lg-8'>"";
            html += ""<input type='text' onkeypress='ValidaNumeros(this);'  maxleng");
            WriteLiteral(@"th='50' id=txtNum"" + id + "" name="" + nome + "" class='form-control'/>"";
            html += ""</div>"";
            html += ""</div>"";
        ...
        function Alternativas(dados, i, id_tipoResposta, valor, id_obrigatorio, id_formulario, chave) {
            ...
            if (dados[i].listDescricaoMultiplaEscolha.length > 0) {
                for (var f = 0; f < dados[i].listDescricaoMultiplaEscolha.length; f++) {
                    html += ""<option value="" + dados[i].listDescricaoMultiplaEscolha[f].id + "">"" + dados[i].listDescricaoMultip");
            WriteLiteral(@"laEscolha[f].nome + ""</option>"";
                }
            }
            html += ""</select >"";
            html += ""</div>"";
        ...
        function Condicao(dados, i, id_tipoResposta, id_obrigatorio, id_formulario, chave) {
            ...
            if");
            WriteLiteral(@" (dados[i].listFilhos.length > 0) {
                listIdsFilhos = [];
                for (var x = 0; x < dados[i].listFilhos.length; x++) {
                    ...
                    if (dados[i].listFilhos[x].id_tipoResposta == 1) //Alternativa
                    {
                        ...
                        html += ""<div class='col-lg-8'>"";
                        html += ""<select id=lst"" + dados[i].listFilhos[x].id_filho + "" name="" + dados[i].listFilhos[x].id_filho + "" class='form-control'>"";

                        for (var t = 0; t < dados[i].listFilhos[x].listDescricaoMultiplaEscolha.length; t++) {
       ");
            WriteLiteral(@"                     html += ""<option value="" + dados[i].listFilhos[x].listDescricaoMultiplaEscolha[t].id + "">"" + dados[i].listFilhos[x].listDescricaoMultiplaEscolha[t].nome + ""</option>"";
                        }
                        html += ""</select >"";
                        html += ""</div>"";
                        html += ""</div>"";
      ...
      ");
            WriteLiteral(@"                  html += ""</div>"";
                    ...
                    if (dados[i].listFilhos[x].id_tipoResposta == 3) //Text
                    {
                        html += ""<div class='row text-left' style='margin-top:10px;'>"";
                        html += ""<div class='col-lg-4'>"";
                        html += ""<label id =lbl"" + dados[i].listFilhos[x].id_filho + "">");
            WriteLiteral(@""" + dados[i].listFilhos[x].nome + ""</label>"";
                        html += ""</div>"";
                        html += ""<div class='col-lg-8'>"";
            ...
            MontaObjsPai(dados[i].id, id_tipoResposta, listIdsFilhos, """", id_obrigatorio, dados[i].nome, id_formulario, chave)
        }
        ...
        function PopulaCampos() {
            ...
            if (listIdsPerguntas.length > 0) {
                ...
                for (var i = 0; i < lis");
            WriteLiteral(@"tIdsPerguntas.length; i++) {
                    ...
                    //Alternativas
                    if (listIdsPerguntas[i].id_tipoResposta == 1) {
                        if (listIdsPerguntas[i].valor == null || listIdsPerguntas[i].valor == 0) {
                            $(""#lst"" + listIdsPerguntas[i].id).val(0);
                        } else {
                            $");
            WriteLiteral(@"(""#lst"" + listIdsPerguntas[i].id).val(listIdsPerguntas[i].valor);
                        }
                    }
                    //Condição
                    if (listIdsPerguntas[i].id_tipoResposta == 2) {
                        ...
                        if (listIdsPerguntas[i].Filho.length > 0) {
                            ...
                            for (var r = 0; r < listIdsPerguntas[i].Filho.length; r++) {
                                ...
                                if (listIdsPerguntas[i].Filho[r].id_tipoResposta == 1) {
      ");
            WriteLiteral(@"                              if (listIdsPerguntas[i].Filho[r].valor == null || listIdsPerguntas[i].Filho[r].valor == """") {
                                ...
                                if (listIdsPerguntas[i].Filho[r].id_tipoResposta == 3) {
                                    ...
                                    $(""#txt"" + listIdsPerguntas[i].Filho[r].id).val(list");
            WriteLiteral(@"IdsPerguntas[i].Filho[r].valor);
                                    if (listIdsPerguntas[i].Filho[r].valor != """" && listIdsPerguntas[i].Filho[r].valor != null) {
                                        cont++;
                                    }
                                    //}
        ...
        function ObtemValorCampos() {
            ...
            WriteLiteral(@"{
                    ...
                    //Alternativas
                    if (listIdsPerguntas[i].id_tipoResposta == 1) {
                        if ($(""#lst"" + listIdsPerguntas[i].id).val() != """") {
                ...
                if (listIdsPerguntas[i].id_tipoResposta == 2) {
                    ...
                    if (listIdsPerguntas[i].Filho.length > 0) {
                        ...
                        for (var r = 0; r < listIdsPerguntas[i].Filho.length; r++) {
                            ...
                            if (listIdsPerguntas[i].Filho[r].id_tipoResposta == 4) {
                                $(""#txtNum"" + listIdsPerguntas[i].Filho[r].id");
            WriteLiteral(@").hide();
        ...
        function HabilitaDesabilitaCampos(id) {
            ...
            if ($(""#"" + id).is("":checked"")) {
                ...
                for (var i = 0; i < listIdsPerguntas.length; i++) {
                    ...
                    if (listIdsPerguntas[i].id_tipoRe");
            WriteLiteral(@"sposta == 2) {
                        ...
                        if (listIdsPerguntas[i].id == id) {
                            ...
                            if (listIdsPerguntas[i].Filho.length > 0) {
                                ...
                                for (var r = 0; r < listIdsPerguntas[i].Filho.length; r++) {
                                    ...
                                    if (listIdsPerguntas[i].Filho[r].id_tipoResposta == 1) {
                                     ");
            WriteLiteral(@"   $(""#lst"" + listIdsPerguntas[i].Filho[r].id).show();
                                        $(""#lbl"" + listIdsPerguntas[i].Filho[r].id).show();
                                    }
                                }
                            }
        ...
        function ValidaNumeros(x) {
            ...
            if ((event.which != 46 || $(x).val().indexOf('.') != -1) && (event.which < 48 || event.wh");
            WriteLiteral(@"ich > 57)) {
       ...
       // //Notificação Líder
        ...
        function ConsultarListaUsuarios() {
            ...
            $.ajax({
  ");
            WriteLiteral(@"              url: ""ConsultarListaUsuarios/JobSetup?idDepartamento="" + departamento, 
                dataType: 'json',
                type: 'GET',
                success: function (data) {
                    var obj = data;
