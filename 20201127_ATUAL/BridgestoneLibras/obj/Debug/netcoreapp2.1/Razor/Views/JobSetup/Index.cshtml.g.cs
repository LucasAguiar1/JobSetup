#pragma checksum "C:\ProjetosManufatura\JobSetup\20201127_ATUAL\BridgestoneLibras\Views\JobSetup\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b2b618965ca5d3ff500bb2cdd6ae5377da5a84cb"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b2b618965ca5d3ff500bb2cdd6ae5377da5a84cb", @"/Views/JobSetup/Index.cshtml")]
    ...
    public class Views_JobSetup_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "399e90253a8e4a8fb59be65e256a9811", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "da2122cf662d443988646eb78d8f5bd8", async() => {
...
<div>
    <script>
            ...
            if (listIdsPerguntas.length > 0) {
                ...
                for (var i = 0; i < listIdsPerguntas.length; i++) {
                    ...
                    if (listIdsPerguntas[i].id_obrigatorio == 1 && (listIdsPerguntas[i].valor == """" || listIdsPerguntas[i].valor == null) && listIdsPerguntas[i].Filho.length == 0) {
                        ...
                        Moda");
            WriteLiteral(@"lAlert(""Por favor, responda a pergunta "" + listIdsPerguntas[i].nome)
                        return false;
                    }
                    if (listIdsPerguntas[i].id_obrigatorio == 1 && (listIdsPerguntas[i].valor == """" || listIdsPerguntas[i].valor == null) && listIdsPerguntas[i].Filho.length > 0 && $(""#"" + listIdsPerguntas[i].id).is("":checked"")) {
                        ...
                        for (var r = 0; r < listIdsPerguntas[i].Filho.length; r++) {
                            ...
                            if (listIdsPerguntas");
            WriteLiteral(@"[i].Filho[r].id_tipoResposta == 3) {
        ...
        function Numero(nome, id, id_tipoResposta, valor, id_obrigatorio, id_formulario, chave) {
            ...
            html += ""<div class='col-lg-4'>"";
            ht");
            WriteLiteral(@"ml += ""<label>"" + nome + ""</label>"";
            html += ""</div>"";
            html += ""<div class='col-lg-8'>"";
        ...
        function Alternativas(dados, i, id_tipoResposta, valor, id_obrigatorio, id_formulario, chave) {
            ...
            if (dados[i].listDescricaoMultiplaEscolha.length > 0) {
                for");
            WriteLiteral(@" (var f = 0; f < dados[i].listDescricaoMultiplaEscolha.length; f++) {
            ...
            if (dados[i].listFilhos.length > 0) {
                ...
                for (var x = 0; x < dados[i].listFilhos.length; x++) {
                    ...
                    if (dados[i].listFilhos[x].id_tipoResposta == 1) //Alternativa
                    {
                        ...
                        html += ""<div class='col-lg-8'>"";
                        html += ""<select id=lst"" + dados[i].listFilhos[x].id_fil");
            WriteLiteral(@"ho + "" name="" + dados[i].listFilhos[x].id_filho + "" class='form-control'>"";
 ...
 ");
            WriteLiteral(@"                       html += ""<div class='col-lg-4'>"";
                    ...
                    {
                        html += ""<div");
            WriteLiteral(@" class='row text-left' style='margin-top:10px;'>"";
                        html += ""<div class='col-lg-4'>"";
                        html += ""<label id =lbl"" + dados[i].listFilhos[x].id_filho + "">"" + dados[i].listFilhos[x].nome + ""</label>"";
                        html += ""</div>"";
                        html += ""<div class='col-lg-8'>"";
            ...
            MontaObjsPai(dados[i].id, id_tipoResposta, listIdsFilhos, """", id_obrigatorio,");
            WriteLiteral(@" dados[i].nome, id_formulario, chave)
        }
            ...
            if (listIdsPerguntas.length > 0) {
                ...
                for (var i = 0; i < listIdsPerguntas.length; i++) {
                    ...
                    if (listIdsPerguntas[i].id_tipoResposta == 1) {
                        if (listIdsPe");
            WriteLiteral(@"rguntas[i].valor == null || listIdsPerguntas[i].valor == 0) {
     ...
     ");
            WriteLiteral(@"           //alert($(""#identificadorLote"").val());
            ...
            for (var i = 0; i < listIdsPerguntas.length; i++) {
                ...
                if (listIdsPerguntas[i].id_tipoResposta == 2) {
                    ...
                    if (listIdsPerguntas[i].Filho.length > 0) {
                        ...
                        for (var r = 0; r < listIdsPe");
            WriteLiteral(@"rguntas[i].Filho.length; r++) {
                            ...
                            if (listIdsPerguntas[i].Filho.length > 0) {
                                ...
                                for (var r = 0; r < listIdsPerguntas[i].Filho.length; r++) {
                                    ...
                                    if (listIdsPerguntas[i].Filho[r].id_tipoResposta == 3) {
                                        ...
                                        $(""#lbl"" + listIdsPergunt");
            WriteLiteral(@"as[i].Filho[r].id).show();
                                    }
                                    if (listIdsPerguntas[i].Filho[r].id_tipoResposta == 1) {
  ...
  ");
            WriteLiteral(@"      function ValidaNumeros(x) {
      ...
      ");
            WriteLiteral(@"              notificacao: $(""#idtxtNotificacao"").val().trim(),
        ...
        function ModalNotificacao(msn) {
            ...
            var resposta = '';
            $(""#msnNotificacao"").empty();
            resposta = ""<div class='alert alert-danger  text-cente");
            WriteLiteral(@"r' role='alert'>""+ msn + ""</div>"";
