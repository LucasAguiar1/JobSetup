#pragma checksum "C:\ProjetosManufatura\JobSetup\20201127_ATUAL\BridgestoneLibras\Views\MaquinaParte\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f0f195a01f46346fc9ad108ef7b1b0a108000246"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"f0f195a01f46346fc9ad108ef7b1b0a108000246", @"/Views/MaquinaParte/Index.cshtml")]
    ...
    public class Views_MaquinaParte_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "a9728784d2cb43b38963243e5ccb8e02", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "170384389d314d468a4be3a6845bc724", async() => {
...
<script>
    ...
    function Pesquisar() {
        ...
        ");
            WriteLiteral(@"if ($(""#lstDepartamento"").val() != ""0"" && $(""#lstMaquina"").val() == ""0"" && $(""#idtxtParteMaquina"").val() == """") {
    ...
    function ObjetoConsulta(obj, i, cont) {
        ...
        b[");
            WriteLiteral(@"""maquina""] = copyData[i].maquina;
    ...
    function CarregaGrid(dados, tipo) {
        ...
        html += ""<th style='width: 1%");
            WriteLiteral(@";'><button type='button' class='btn btn -default btn - md' onclick='ConsultarGrid()' data-toggle='tooltip' title='Atualizar Consulta' style='color:red'><span style='' class='glyphicon glyphicon-refresh'></span></button><span></span></th>"";
        ...
        if (dados.length > 0) {
            for (var r = 0; r < dados.length; r++) {
                ...
                if (dados[r].status == 1) {
                    html += ""<td  data-toggle='tooltip' title='Ativo' ><button type='but");
            WriteLiteral(@"ton' style='margin-left:8px;' class='btn btn-white' value="" + dados[r].id + ""  id='btn_Alterar_"" + dados[r].id + ""  ' onclick='AtivoInativo(this)'><span  style='color: green;' class='glyphicon glyphicon-ok' ></button></td>"";
                } else {
        ...
        //        if (dados != null) {
     ");
            WriteLiteral(@"   //            html += ""<tr style='text-align:center;'>"";
        ...
        //            html += """);
            WriteLiteral(@"<td><button type='button' style='margin-left:8px;' class='btn btn-white' value="" + dados.id + ""  id='btn_Alterar_"" + dados.id + ""  ' onclick='Editar(this)'><span  style='color: black;' class='glyphicon glyphicon-pencil' ></button></td>"";
        //            html += ""</tr>"";
        //            dados = null;
        //        }
        //        else {
        ...
        //}
            ...
            html += ""<tr style='text-align:center; color:red '>"";
            html += ""<td colspan='12'> Não existe nenhum registro cadast");
            WriteLiteral(@"rado. </td>"";
            html += ""</tr>"";
        }
    ...
    function Cadastrar() {
        if (validarCampos()) {
            if (VerificaExiste()) {
             ...
             ");
            WriteLiteral(@"   eval('var myData = {""' + dadosCadastro + '""}');
    ...
    function validarCampos() {
        ...
        dadosCadastro += '"",""' + ""nome"" + '"":""' + ca");
            WriteLiteral(@"racterSpecial($(""#idtxtParteMaquina"").val());
