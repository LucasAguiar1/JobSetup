#pragma checksum "C:\ProjetosManufatura\JobSetup\20201127_ATUAL\BridgestoneLibras\Views\Departamento\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4a94f03c895aabd6ba8598403882df9481267fd2"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4a94f03c895aabd6ba8598403882df9481267fd2", @"/Views/Departamento/Index.cshtml")]
    ...
    public class Views_Departamento_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5f3e3a168d3e411798b19d08e98e49fd", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e591237d9a79439bbc464094f1c24b33", async() => {
...
<script>
    ...
    function Pesquisar() {
        ...
        //if ($(""#idCodDepartamento"").val() != """" && $(""#idDepartamento"").val() == """" && $(""#lstStatus"").val");
            WriteLiteral(@"() == ""0"") {
        //    for (var i = 0; i < copyData.length; i++) {
        ...
        //    }
        //");
            WriteLiteral(@"    if (dadosRetorno != null) {
        //        CarregaGrid(dadosRetorno);
        //        return;
        //    }
        //}
    ...
    function ValidaNumeros(x) {
        ...
        $(x).val");
            WriteLiteral(@"($(x).val().replace(/[^0-9\.]/g, ''));
    ...
    function CarregaGrid(dados) {
        ...
        html += ""<th style='width: 1%;'><button type='button' class='btn btn -default btn - md' onclick='ConsultarDepartamento()' data-toggle='tooltip' title='Atualizar Cons");
            WriteLiteral(@"ulta' style='color:red'><span style='' class='glyphicon glyphicon-refresh'></span></button><span></span></th>"";
        html += ""<th>Código</th>"";
        html += ""<th>Nome</th>"";
        html += ""<th>Status</th>"";
        html += ""<th>Editar</th>"";
