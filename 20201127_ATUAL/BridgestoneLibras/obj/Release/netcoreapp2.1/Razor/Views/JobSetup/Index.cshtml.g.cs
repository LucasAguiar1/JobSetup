#pragma checksum "C:\Projetos\JobSetup\20201127_ATUAL\BridgestoneLibras\Views\JobSetup\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5d0e81e3a1f39d389dfd248358379d0e102c2205"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5d0e81e3a1f39d389dfd248358379d0e102c2205", @"/Views/JobSetup/Index.cshtml")]
    ...
    public class Views_JobSetup_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "170feb58c87047cea675942f097eafc5", async() => {
            ...
            WriteLiteral("\r\n");
            EndContext();
            BeginContext(75, 2786, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "60310d4ecc54410db9c80fb17c6cf8ad", async() => {
                BeginContext(81, 2773, true);
                WriteLiteral(@"
...
<div>
    <script>
        ...
        function MaquinasParte(id) {
            $.ajax({
                ...
                success: function (data) {
                    if (data.length == 0) {
          ");
            WriteLiteral(@"              alert(data.length);
        ...
        function Perguntas(id, flag) {
            ...
            listIdsPerguntas = [];
            $.ajax({
                url: ""Perguntas/JobSetu");
            WriteLiteral(@"p?idFormulario="" + id,
                dataType: 'json',
                type: 'GET',
                success: function (data) {
                    if (data.length == 0) {
        ...
        function MontarLI_Menu(menu) {
            ...
            if (menu != ""Departament");
            WriteLiteral(@"os"") {
                html += ""<button type='button' style='color:red' class='btn btn-link' onclick='Voltar();' >("" + menu + "" ) Voltar</button>"";
            } else {
 ...
 ");
            WriteLiteral(@"                   Text(dados[i].nome, dados[i].id, dados[i].id_tipoResposta, dados[i].valor, dados[i].id_obrigatorio, dados[i].id_formulario, dados[i].chave);
            ...
            html += ""<div class='row' style='margin-top:10px;margin-bott");
            WriteLiteral(@"om:56px';>"";
...
");
            WriteLiteral(@"
                                ...
                                if (listIdsPerguntas[i].Filho[r].id_tipoResposta == 4) {
                                    ...
                                    if (listIdsPerguntas[i].Filho[r].id_obrigatorio == 1 && listIdsPergunta");
            WriteLiteral(@"s[i].Filho[r].valor == """") {
                                        //return false;
                                        cont++;
                                    }
                                }
                    ...
                    if (listIdsPerguntas[i].id_obrigatorio == 1 && (listIdsPerguntas[i].valor == """" || listIdsPerguntas[i].valor == null) && listIdsPerguntas[i].Filho.length > 0 && $(""#"" + listIdsPerguntas[i].id).is("":checked"")) {
                        ...
                        for (var r = 0; r < listIdsPerguntas[i].Filho.length; r++) {
                            ...
                            if (listIdsPerguntas[i].Filho[r].id_tipoResposta == 3) {
                                ...
                                if (lis");
            WriteLiteral(@"tIdsPerguntas[i].Filho[r].id_obrigatorio == 1 && (listIdsPerguntas[i].Filho[r].valor == """" || listIdsPerguntas[i].Filho[r].valor == null)) {
        ...
        function");
            WriteLiteral(@" Text(nome, id, id_tipoResposta, valor, id_obrigatorio, id_formulario, chave) {
            listIdsFilhos = [];
        ...
        function Numero(nome, id, id_tipoResposta, valor, id_obrigatorio, id_formulario, chave) {
            ...
            html += ""</div>"";
          ");
            WriteLiteral(@"  html += ""<div class='col-lg-8'>"";
        ...
        ");
            WriteLiteral(@"            html += ""<option value="" + dados[i].listDescricaoMultiplaEscolha[f].id + "">"" + dados[i].listDescricaoMultiplaEscolha[f].nome + ""</option>"";
                }
            }
            html += ""</select >"";
            html += ""</div>"";
        ...
        function Condicao(dados, i, id_tipoResposta, id_obrigatorio, id_formulario, chave) {
            ...
            html += ""<label style='margin-left:-149px;' for="" + dados[i].id +");
            WriteLiteral(@" ""> "" + dados[i].nome + ""</label><br>"";
            html += ""</div>"";
            html += ""</div>"";
...
");
            WriteLiteral(@"                        for (var t = 0; t < dados[i].listFilhos[x].listDescricaoMultiplaEscolha.length; t++) {
                    ...
                    if (dados[i].listFilhos[x].id_tipoResposta == 4) //número
                    {
                        ...
                        html += ""<div class='col-lg-4'>"";
                     ");
            WriteLiteral(@"   html += ""<label id =lbl"" + dados[i].listFilhos[x].id_filho + "">"" + dados[i].listFilhos[x].nome + ""</label>"";
                        html += ""</div>"";
                    ...
                    if (dados[i].listFilhos[x].id_tipoResposta == 3) //Text
                    {
                        html += ""<div class='row text-left' style='margin-top:10px;'>"";
                        htm");
            WriteLiteral(@"l += ""<div class='col-lg-4'>"";
                        html += ""<label id =lbl"" + dados[i].listFilhos[x].id_filho + "">"" + dados[i].listFilhos[x].nome + ""</label>"";
                        html += ""</div>"";
                        html += ""<div class='col-lg-8'>"";
        ...
        function MontaObjsP");
            WriteLiteral(@"ai(id, id_tipoResposta, listIdsFilhos, valor, id_obrigatorio, nome, id_formulario, chave) {
        ...
        function PopulaCampos() {");
            ...
            if (listIdsPerguntas.length > 0) {
                ...
                ");
            WriteLiteral(@"            $(""#lst"" + listIdsPerguntas[i].id).val(0);
                        } else {
            ...
            WriteLiteral(@"                    }
                                ...
                                if (listIdsPerguntas[i].Filho[r].id_tipoResposta == 3) {
                                    ...
                                    //if ($(""#txt"" + listIdsPerguntas[i");
            WriteLiteral(@"].Filho[r].id).val() != """") {
        ...
        function ObtemValorCampos() {
            ...
            WriteLiteral(@"       //Text
                    ...
                    //Condição
              ");
            WriteLiteral(@"      if (listIdsPerguntas[i].id_tipoResposta == 2) {
        ...
        ");
            WriteLiteral(@"                        if (listIdsPerguntas[i].Filho[r].id_tipoResposta == 3) {
       ...
       ");
            WriteLiteral(@"                         $(""#lbl"" + listIdsPerguntas[i].Filho[r].id).hide();
                            }
                            if (listIdsPerguntas[i].Filho[r].id_tipoResposta == 3) {
...
");
            WriteLiteral(@"                        if (listIdsPerguntas[i].id == id) {
                            ...
                            if (listIdsPerguntas[i].Filho.length > 0) {
                                ...
                                for (var r = 0; r < listIdsPerguntas[i].Filho.length; r++) {
                                    ...
                                    if (listIdsPerguntas[i].Filho[r].id_tipoResposta == 1) {
                                        $(""#lst"" + list");
            WriteLiteral(@"IdsPerguntas[i].Filho[r].id).show();
                                        $(""#lbl"" + listIdsPerguntas[i].Filho[r].id).show();
                                    }
                                }
                            }
 ...
 ");
        ...
        function ConsultarListaUsuarios() {
            ...
            $.ajax({
                url:");
            WriteLiteral(@" ""ConsultarListaUsuarios/JobSetup?idDepartamento="" + departamento, 
                dataType: 'json',
                type: 'GET',
                success: function (data) {
                    var obj = data;
