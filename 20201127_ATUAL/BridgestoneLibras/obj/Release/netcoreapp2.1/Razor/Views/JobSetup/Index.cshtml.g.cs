#pragma checksum "C:\ProjetosManufatura\JobSetup\20201127_ATUAL\BridgestoneLibras\Views\JobSetup\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "62f83cf326776bb400ca4f6aee467ced840a07f5"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"62f83cf326776bb400ca4f6aee467ced840a07f5", @"/Views/JobSetup/Index.cshtml")]
    ...
    public class Views_JobSetup_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "ffbee4bcfe804ff5b8f50990722bd9d2", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "f95af895d96f4ca88833f0ff36e01dd8", async() => {
...
<div>
    <script>
        ...
        function montaFormulario(dados) {
            ...
            for (var i = 0; i < dados.length; i++) {
                if (contador == 0) {
                    ...
                    html += ""<h4><label id='identificadorLote'> Lote PCS: "" + dados[i].identificadorLote + ""</label></h4>"";
                    html += ""</div>"";
                    html += ""</div>"";
                }
                contador++;");
        ...
        function FinalizarRespostaPergun");
            WriteLiteral(@"ta() {
        ...
        function VerificaObrigatoriedadeBotaoSalvar() {
            ...
            if (listIdsPerguntas.length > 0) {
                ...
                for (var i = 0; i < listIdsPerguntas.length; i++) {
                    ...
                    if (listIdsPerguntas[i].id_tipoResposta == ");
            WriteLiteral(@"1) {
                    ...
                    if (listIdsPerguntas[i].id_tipoResposta == 2) {
                        if (listIdsPerguntas[i].id_obrigatorio == 1 && listIdsPerguntas[i].valor == """" && listIdsPerguntas[i].Filho.le");
            WriteLiteral(@"ngth > 0 && $(""#"" + listIdsPerguntas[i].id).is("":checked"")) {
                            ...
                            for (var r = 0; r < listIdsPerguntas[i].Filho.length; r++) {
                                ...
                                if (listIds");
            WriteLiteral(@"Perguntas[i].Filho[r].id_tipoResposta == 4) {
        ...
        function VerificaObrigatoriedade() {
            ...
            if (listIdsPerguntas.length > 0) {
                ...
                for (var i = 0; i < listIdsPerguntas.length; i++) {
                    ...
                    if (listIdsPerguntas[i].id_obrigatorio == 1 && (listIdsPerguntas[i].valor == """" || listIdsPerguntas[i].valor == null) ");
            WriteLiteral(@"&& listIdsPerguntas[i].Filho.length == 0) {
      ...
      ");
        ...
        function Numero(nome, id, id_tipoResposta, valor, id_obrigatorio, id_formulario, chave) {
            listIdsFilhos = [];
            html += ""<div class='row text-left' style='margin-t");
        ...
        function Alternativas(dados, i, id_tipoResposta, valor, id_obrigatorio, id_formulario, chave) {
            ...
            i");
            WriteLiteral(@"f (dados[i].listDescricaoMultiplaEscolha.length > 0) {
            ...
            if (dados[i].listFilhos.length > 0) {
                ...
                for (var x = 0; x < dados[i].listFilhos.length; x++) {
                    ...
                    if (dados[i].listFilhos[x].id_tipoResposta == 1) //Alternativa
                    {
                        ...
                        html += ""<div class='col-lg-8'>"";
     ");
            WriteLiteral(@"                   html += ""<select id=lst"" + dados[i].listFilhos[x].id_filho + "" name="" + dados[i].listFilhos[x].id_filho + "" class='form-control'>"";
            ...
            WriteLiteral(@"         html += ""<div class='row text-left' style='margin-top:10px;'>"";
                    ...
                    if (dados[i].listFilhos[x].id_tipoResposta");
            WriteLiteral(@" == 3) //Text
                    {
                        html += ""<div class='row text-left' style='margin-top:10px;'>"";
                        html += ""<div class='col-lg-4'>"";
            ...
            Mo");
            WriteLiteral(@"ntaObjsPai(dados[i].id, id_tipoResposta, listIdsFilhos, """", id_obrigatorio, dados[i].nome, id_formulario, chave)
        }
        ...
        function PopulaCampos() {
            ...
            if (listIdsPerguntas.length > 0) {
                ...
                for (var i = 0; i < listIdsPerguntas.length; i++) {
                    ...
                    //Alternativas
                    if (listIds");
            WriteLiteral(@"Perguntas[i].id_tipoResposta == 1) {
                        ...
                        if (listIdsPerguntas[i].Filho.length > 0) {
                            ...
                            for (var r = 0; r < listIdsPerguntas[i].Filho.length; r++) {
                                ...
                                if (listIdsPerguntas[i].Filho[r].id_tipoResposta == 4) {
                                    ...
                                    if (listIdsPerguntas[i].Filho[r].valor != """);
            WriteLiteral(@""" && listIdsPerguntas[i].Filho[r].valor != null) {
                                        cont++;
                                    }
        ...
        function Obte");
            ...
            WriteLiteral(@"esposta == 1) {
                    ...
                    ");
            WriteLiteral(@"                if ($(""#lst"" + listIdsPerguntas[i].Filho[r].id).val() != """") {
        ...
        function DesabilitaCampos() {
            for (var i = 0; i < listIdsPerguntas.length; i++) {
                ...
                if (listIdsPerguntas[i].id_tipoResposta == 2) {
                    ...
                    if (listIdsPerguntas[i].F");
            WriteLiteral(@"ilho.length > 0) {
                        ...
                        if (listIdsPerguntas[i].id == id) {
                            ...
                            if (listIdsPerguntas[i].Filho.length > 0) {
                                ...
                                for (var r = 0; r < listIdsPerguntas[i].Filho.length; r++) {
                                    ...
                                    if (listIdsPerguntas[i].Filho[r].id_tipoResposta == 3) {
                                        $(""#txt"" + listIdsPerguntas[i].Filho[r].id)");
            WriteLiteral(@".show();
                                        $(""#lbl"" + listIdsPerguntas[i].Filho[r].id).show();
                                    }
                                    if (listIdsPerguntas[i].Filho[r].id_tipoResposta == 1) {
                    ...
                    if (listIdsPerguntas[i].id_tipoResposta == 2) {
                        ...
                        if (listIdsPerguntas[i].id == id) {
                            ...
                            if (listIdsPerguntas[i].Filho.length > 0) {
                                ...
                                for (var r = 0; r < listIdsPerguntas[i].Filho.length; r++) {
                            ");
            WriteLiteral(@"        if (listIdsPerguntas[i].Filho[r].id_tipoResposta == 4) {
                                        $(""#txtNum"" + listIdsPerguntas[i].Filho[r].id).hide();
                                        $(""#lbl"" + listIdsPerguntas[i].Filho[r].id).hide();
                                    }
                                    if (listIdsPerguntas[i].Filho[r].id_tipoResposta == 3) {
