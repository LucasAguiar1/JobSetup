#pragma checksum "C:\ProjetosManufatura\JobSetup\20201127_ATUAL\BridgestoneLibras\Views\JobSetup\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5fcbaabae64a2c54f4430180497a4f6f8e5a4b8e"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5fcbaabae64a2c54f4430180497a4f6f8e5a4b8e", @"/Views/JobSetup/Index.cshtml")]
    ...
    public class Views_JobSetup_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "b72f08ae02e9499ead6dc43c441d1cbb", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "fa48243093f84879af9b9b1a2160f999", async() => {
...
<div>
        ...
        function montaFormulario(dados) {
            ...
            for (var i = 0; i < dados.length; i++) {
                if (contador == 0) {
                    ...
                    html += ""<h4><label id='identificadorLote'> Lote PCS: "" + dados[i].identificadorLote +  ""</label>     <button type='button' style='color:red' class='btn btn-default' onclick='AtualizarPCS();' >Atualizar PCS</button></h4>"";
      ");
            WriteLiteral(@"              html += ""</div>"";
                ...
                if (dados[i].id_tipoResposta == 2) {
                    Condicao(dados, i, d");
            WriteLiteral(@"ados[i].id_tipoResposta, dados[i].id_obrigatorio, dados[i].id_formulario, dados[i].chave);
                }
            }
            ...
            html += ""</div>"";
            html += ""<div class='col-lg-3'>"";
            html += ""<button type='button' id='btnLider' onclick='FinalizarRespostaPergunta()' class=");
            WriteLiteral(@"'btn btn-outline-danger btn-block'>Finalizar</button>"";
            html += ""</div>"";
        ...
        function Salvar() {
            ...
            ");
            WriteLiteral(@"    ModalAlert(""É necessário responder pelo menos uma  pergunta para salvar o formulário."")
       ...
       ");
        ...
        function VerificaObrigatoriedadeBotaoSalvar() {
            ...
            if (listIdsPerguntas.length > 0) {
                ...
                for (var i = 0; i < listIdsPerguntas.length; i++) {
                    ...
                    if (listIdsPerguntas[i].id_tipoR");
        ...
        function VerificaObrigatoriedade() {
            ...
            if (listIdsPerguntas.length > 0) {
                ...
                for (var i = 0; i < listIdsPerguntas.length; i++) {
                    ...
                    if (listIdsPerguntas[i].id_obrigat");
            WriteLiteral(@"orio == 1 && (listIdsPerguntas[i].valor == """" || listIdsPerguntas[i].valor == null) && listIdsPerguntas[i].Filho.length > 0 && $(""#"" + listIdsPerguntas[i].id).is("":checked"")) {
                        ...
                        for (var r = 0; r < listIdsPerguntas[i].Filho.length; r++) {
                            ...
                            if (listIdsPerguntas[i].Filho[r].id_tipoResposta == 3) {
                                ...
                                if (listIdsPerguntas[i].Filho[r].id_obrigatorio == 1 && (listIdsPerguntas[i].Filho[r].valor == """" || listIdsPergun");
            WriteLiteral(@"tas[i].Filho[r].valor == null)) {
        ...
        function Numero(nome, id, id_tipoResposta, valor, id_obrigatorio, id_formulario, chave) {
            ...
            html += ""</div>"";
            html += ""<div class='col-lg-8'>"";
            html += ""<input type='text' onkeypress='ValidaNumeros(this");
            WriteLiteral(@");'  maxlength='50' id=txtNum"" + id + "" name="" + nome + "" class='form-control'/>"";
            html += ""</div>"";
            html += ""</div>"";
        ...
        function Alternativas(dados, i, id_tipoResposta, valor, id_obrigatorio, id_formulario, chave) {
            ...
            if (dados[i].listDescricaoMultiplaEscolha.length > 0) {
                for (var f = 0; f < dados[i].listDescricaoMultiplaEscolha.length; f++) {
                    html += ""<option value="" + dados[i].listDescricaoMultiplaEscolha[f].id + "">"" + dados[i].listDes");
            WriteLiteral(@"cricaoMultiplaEscolha[f].nome + ""</option>"";
                }
            }
            html += ""</select >"";
            html += ""</div>"";
  ...
  ");
            WriteLiteral(@"          if (dados[i].listFilhos.length > 0) {
                listIdsFilhos = [];
            ...
            WriteLiteral(@") {
                    ...
                    if (dados[i].listFilhos[x].id_tipoResposta == 4) //número
                    {
                        html += ""<div class='row text-left' style='margin-top:10px;'>"";
                        html += ""<div class='col-lg-4'>"";
                        html += ""<label id =lbl"" + dados[i].listFilhos[x].id_filho + "">"" + dados[i].listFilhos[x].nome + ""</labe");
            WriteLiteral(@"l>"";
                        html += ""</div>"";
                    ...
                    if (dados[i].listFilhos[x].id_tipoResposta == 3) //Text
                    {
                        html += ""<div class='row text-left' style='margin-top:10px;'>"";
                        html += ""<div class='col-lg-4'>"";
                        html += ""<label id =lbl"" + dados[i].listFilhos[x].i");
            WriteLiteral(@"d_filho + "">"" + dados[i].listFilhos[x].nome + ""</label>"";
                        html += ""</div>"";
                        html += ""<div class='col-lg-8'>"";
        ...
        function PopulaCampos() {
            ...
            if (listIdsPerguntas.length > 0) {
                ...
                for (var i ");
            WriteLiteral(@"= 0; i < listIdsPerguntas.length; i++) {
                    ...
                    if (listIdsPerguntas[i].id_tipoResposta == 2) {
                        ...
                        if (listIdsPerguntas[i].Filho.length > 0) {
                            ...
                            for (var r = 0; r < listIdsPerguntas[i].Filho.length; r++) {
                                ...
                                if (listIdsPerguntas[i].Filho[r].id_tipoResposta == ");
            WriteLiteral(@"1) {
                                ...
                                if (listIdsPerguntas[i].Filho[r].id_tipoResposta == 3) {
                                    ...
                                    $(""#txt"" + listIdsPerguntas[i].Filho[r].");
            WriteLiteral(@"id).val(listIdsPerguntas[i].Filho[r].valor);
                                    if (listIdsPerguntas[i].Filho[r].valor != """" && listIdsPerguntas[i].Filho[r].valor != null) {
                                        cont++;
                                    }
                                    //}
        ...
        function ObtemValorCampos() {
            ...
            if (listIdsPerguntas.length > 0) {
                ...
                for (var i = 0; i < listIdsPerguntas.l");
                ...
                if (listIdsPerguntas[i].id_tipoResposta == 2) {
                    ...
                    if (listIdsPerguntas[i].Filho.length > 0) {
                        ...
                        for (var r = 0; r < listIdsPerguntas[i].Filho.length; r++) {
                            ...
                            if (listIdsPerguntas[i].Filho[r].id_tipoResposta == 4) {
                                $(""#txtNum"" + listIdsPerguntas[i]");
            WriteLiteral(@".Filho[r].id).hide();
        ...
        function HabilitaDesabilitaCampos(id) {
            ...
            if ($(""#"" + id).is("":checked"")) {
                ...
                for (var i = 0; i < listIdsPerguntas.length; i++) {
                    ...
                    if (listIdsPerguntas[");
            WriteLiteral(@"i].id_tipoResposta == 2) {
      ...
      ");
        ...
        function ValidaNumeros(x) {
            ...
            if ((event.which != 46 || $(x).val().indexOf('.') != -1) && (event.which < 48");
            WriteLiteral(@" || event.which > 57)) {
       ...
       // //Notificação Líder
        ...
        function CadastrarNotificacao() {
            ...
            if ($(""#idtxtNotificacao"").val() != """") {
                ...
                $.ajax({
                    u");
            WriteLiteral(@"rl: 'Notificacao/JobSetup',
                    type: 'POST',
                    traditional: true,
