#pragma checksum "C:\Projetos\JobSetup\20201127_ATUAL\BridgestoneLibras\Views\NotificacaoLider\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d06921c66b4af4097a6abc9e4bb556fd018b915c"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d06921c66b4af4097a6abc9e4bb556fd018b915c", @"/Views/NotificacaoLider/Index.cshtml")]
    ...
    public class Views_NotificacaoLider_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            EndContext();
            BeginContext(25, 53, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "2face1f97b0d40c98d095b5d32651ed2", async() => {
            ...
            WriteLiteral("\r\n");
            EndContext();
            BeginContext(80, 8505, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6cebc656947e40eaa491496a96f3134a", async() => {
                BeginContext(86, 8492, true);
                WriteLiteral(@"
    ...
    <div class=""container"">
        ...
        <div class=""row"" style=""margin-top: 16px;"">
            ...
            <div class=""col-lg-2"">
                <button type=""button"" id=""btnConsultar"" onclick=""Consultar();"" class=""btn btn-outline-danger btn-block ""><span style=""color: black;"" class=""glyphicon glyphicon-search""></span>");
                WriteLiteral(@"</button>
            </div>
            <div class=""col-lg-2"">
        ...
        <div class=""modal-dialog"" role=""document"">
            <div class=""modal-content"">
                ...
                <div class=""modal-footer"">
                    <button t");
                WriteLiteral(@"ype=""button"" class=""btn btn-secondary"" data-dismiss=""modal"" style=""margin:auto; background-color: black;"">Ok</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class=""modal-content"">
                ...
                <div class=""modal-body"">
                    <div class=""form-group"">
                        ...
                        <textarea class=""for");
                WriteLiteral(@"m-control rounded-0"" id=""idtxtNotificacaoObs"" rows=""5""></textarea>
                    </div>
                </div>
                <div class=""modal-footer"">
                    <button type=""button"" id=""btnReposnderNotificacao"" data-dismiss=""modal"" class=""btn btn-outline-danger  btn-block"" onclick=""ModalObsLider(this)""  style=""margin-top: 0px;"">Resposnder Notificação</button>
...
<script>
    ...
    function CarregaGrid() {
        ...
        $.ajax({
  ");
            WriteLiteral(@"          url: ""CarregaGrid/NotificacaoLider"",
            dataType: 'json',
            type: 'GET',
                ...
                if (obj.length == 0) {
                    ...
                    $.each(obj, function (i, index) {
                        $(""#lstDepartamento"").append(
                            $('<option></option>').val(index");
            WriteLiteral(@".value).html(index.text));
                    })
    ...
    ");
            WriteLiteral(@"                $(""#lstMaquina"").prop('selectedIndex');
                }
            },
            error: function (data) {
                alert(""erro"");
...
");
    ...
    function Grid(dados) {
        ...
        if (dados.length > 0) {
            ...
            for (var r = 0; r < dados.length; r++) {
                ...
                html += ""<td data-toggle='tooltip' title='Notificação Operador' ><button type='button' style='margin-left:8px;' clas");
            WriteLiteral(@"s='btn btn-white' value=''  onclick=ModalobsOperador("" + dados[r].id + ""); ><span style='color: gray;' class='glyphicon glyphicon-search' ></button></td>"";
                ...
                if (dados[r].observacaoLider == """") {
                    ...
                    if (permissao == ""CADASTRAPERGUNTA"") {
                        ...
                        html += ""<td data-toggle='tooltip' title='Obs Líder' ><button type='button' style='margin-left:8px;' class='btn btn-white' value=''  onclick=ModalObsLider("" + dados[r].id + "")><span style='color: gray;' class='glyphicon glyphicon-plus' ></b");
            ...
            html += ""<tr style='text-");
            WriteLiteral(@"align:center; color:red '>"";
    ...
    function Tabela() {
        ...
        html += ""<th>Obs Líder</th>"";
        html +=");
            WriteLiteral(@" ""<th>Data Obs Líder</th>"";
        html += ""<th>Lida</th>"";
        html += ""<th>Data Lida</th>"";
    ...
    function CadastrarObsLider() {
        ...
        if (validaObsLider()) {
            var id = 0;
            if (idRegistro.value != 0 && idReg");
            WriteLiteral(@"istro.value != null) {
                id = idRegistro.value;
            } else {
                id = idRegistro;
            }
