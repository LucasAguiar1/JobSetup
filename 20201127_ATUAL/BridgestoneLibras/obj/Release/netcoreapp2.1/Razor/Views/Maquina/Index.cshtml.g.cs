#pragma checksum "C:\ProjetosManufatura\JobSetup\20201127_ATUAL\BridgestoneLibras\Views\Maquina\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "18bb4e17be3c35d6db276518f44b3b9c93640167"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"18bb4e17be3c35d6db276518f44b3b9c93640167", @"/Views/Maquina/Index.cshtml")]
    ...
    public class Views_Maquina_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "b444255ce6044c7ab06a84fd735a7176", async() => {
            ...
            WriteLiteral("\r\n");
            EndContext();
            BeginContext(75, 6138, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "920c5b1e947f4ee281369058391a7b23", async() => {
                BeginContext(81, 4635, true);
                WriteLiteral(@"
...
");
    ...
    function addCodigoPCS(id) {
        ...
        vc_Descripcion = """";
     ");
            WriteLiteral(@"   for (var i = 0; i < copyPCS.length; i++) {
    ...
    function validarCampos() {
        ...
        if ($(""#idNomeMaquina"").val() == """") {
            ModalAlert(""Por favor, i");
            WriteLiteral(@"nforme o nome da Máqina."");
            return false;
        }
    ...
    function VerificaExiste() {
        ...
        for (var i = 0; i < copyData.length; i++) {
            ...
            if ($(""#idNomeMaquina"").val().trim().toUpperCase() == copyData[i].nome.trim().toUpperCase() && $(""#lstDepartamento"").val() == copyData[i].id_departamento) {
                ...
                ModalAlert(""Não é possível efetuar o cadas");
            WriteLiteral(@"tro, o registro já exste."");
                return false;
            }
        }
        return true;
  ...
  ");
    ...
    function AtivoInativo(id) {
     ...
     ");
            WriteLiteral(@"               dadosCadastro += '"",""' + ""status"" + '"":""' + 2
                } else {
    ...
    function ExcluirPcsGRID(id) {
        ...
        for (var i = 0; i < copyData.length; i++) {
            if (copyData[i].id == id) {
                ...
                dadosCadastro += '"",""' + ""i_Pk_Maquina"" + '"":""' + i_Pk_Maquina;
                dadosCadastro += '"",""' + ""vc_Descripcion"" + '"":""' + vc_Descripcion;
                dadosCadastro += '"",""' + ""codigoTess"" + '"":""' + copyData[i].codigo");
            WriteLiteral(@"Tess;
  ...
  ");
            WriteLiteral(@"      html += ""<th>Máquina</th>"";
        ...
        if (dados.length > 0) {
            for (var r = 0; r < dados.length; r++) {
              ...
              ");
            WriteLiteral(@"  if (dados[r].i_Pk_Maquina != """") {
                ...
                if (dados[r].status == 1) {
                    ...
                    html += ""<td  data-toggle='tooltip' title='Inativo' ><button type='button' style='margin-left:8px;' class='btn btn-white' value="" + dados[r].id + ""  id='btn_Alterar_"" + dados[r].id + ""  ' onclick='AtivoInativo(this)'><span  style='co");
            WriteLiteral(@"lor: red;' class='glyphicon glyphicon-ok' ></button></td>"";
                }
