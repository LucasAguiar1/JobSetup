...
{
    public class ApplicationDbSpecContext : IdentityDbContext<IdentityUser>, IDesignTimeDbContextFactory<ApplicationDbSpecContext>
    {
        public ApplicationDbSpecContext(DbContextOptions<ApplicationDbSpecContext> options)
            : base(options)
        {
        }
        ...
        public ApplicationDbSpecContext CreateDbContext(string[] args)
        {
