...
/****** Object:  Job [LHH - Importe Diário]    Script Date: 26/07/2019 17:27:17 ******/
BEGIN TRANSACTION
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'LHH - Importe Diário', 
		@enabled=1, 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N'Processamento diário de importação de dados para alimentação do sistema Libras Homem Hora', 
