#pragma checksum "C:\Projetos\Backup JOB Setup\20201127_FILTROS_OK2\BridgestoneLibras\Views\TipoResposta\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "745e73fd05cc6b2584b33aed1e259586e0621fdd"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"745e73fd05cc6b2584b33aed1e259586e0621fdd", @"/Views/TipoResposta/Index.cshtml")]
    ...
    public class Views_TipoResposta_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "f16a5cecf7c54896934385b2082c1540", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "a75b77a17aec45c69b2221c97a37c224", async() => {
...
<script>
    ...
    function ModalAlert(msn) {
        ...
        var resposta = '';
        $(""#idmsn"").empty();
        resposta = ""<div class='ale");
            WriteLiteral(@"rt alert-danger  text-center' role='alert'>"" + msn + ""</div>"";
    ...
    function caracterSpecial(text) {
        ...
        return t");
            WriteLiteral(@"ext.trim().replace(/&/g, ""&amp;"").replace(/>/g, ""&gt;"").replace(/</g, ""&lt;"").replace(/""/g, ""&quot;"");
    }
    ...
    function CarregaGrid(dados, tipo) {
        ...
        if (dados.length > 0) {
            for (var r = 0; r < dados.length; r++) {
                ...
                if (dados[r].status == 1) {
                    html += ""<td  data-toggle='t");
            WriteLiteral(@"ooltip' title='Ativo' ><button type='button' style='margin-left:8px;' class='btn btn-white' value="" + dados[r].id + ""  id='btn_Alterar_"" + dados[r].id + ""  ' onclick='AtivoInativo(this)'><span  style='color: green;' class='glyphicon glyphicon-ok' ></button></td>"";
                } else {
        ...
        //            if (dados.status == 1) {
        //                html += ""<td  data-toggle='tooltip'");
            WriteLiteral(@" title='Ativo' ><button type='button' style='margin-left:8px;' class='btn btn-white' value="" + dados.id + ""  id='btn_Alterar_"" + dados.id + ""  ' onclick='AtivoInativo(this)'><span  style='color: green;' class='glyphicon glyphicon-ok' ></button></td>"";
        //            } else {
